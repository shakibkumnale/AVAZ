...
export default function Contact() {
    const [alerts,setAlerts]= useState("dddddd")
...
const handleForm = async(e)=>{
  ...
  return (
    <div><section className="min-h-screen bg-white dark:bg-gray-900">
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-10">
                ...
                <div className='flex justify-center items-center w-full mb-3  mt-0 '><span className='text-[#1f1f1f] text-xl'>{alerts}</span></div>
                    <div className="-mx-2 md:items-center md:flex">
                        ...
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            ...
                            <input name='cemail' type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="http://localhost:3000/Avaz-logo2.png" alt=""/>
